...
// cards container 3 DYNAMIC
document.getElementById('card-container-1').innerHTML = productsDetail1.map(product =>
  `
    <!-- cardd -->
    <div class="card_x">
        <div class="card mb-3 border-0">
            <div class="row g-0">
                <div class="d-flex justify-content-between align-items-center offer">
                    <span class="text-light px-2 py-1 rounded-pill">${product.off} %
                        off
                    </span>
                    <div class="product_like">
                        <img class="product_like_icon" src="../Images/heart.svg" alt=""
                            width="25px">
                ...
                <div class="col-md-12 ">
                    <div class="card-body text-center">
                        <h5 class="text-uppercase product_name">${product.name}</h5>
                        <p class="card-title">1986 sbl</p>
                        <div class="rating">
                        ...
                        <div class="flex align-items-center justify-content-center">
                            <p class="card-text text-center fw-bold">
                                <s class="text-decoration-line-through fw-normal mx-2 small">₹
                        ...
                        <div class="mt-2">
                            <button href="" class="rounded-pill">buy</button>
                        </div>
                    </div>
                </div>
            </div>
...
//cards container 2 DYNAMIC
document.getElementById('card-container-2').innerHTML = productsDetail2.map(product =>
  `
    <!-- cardd -->
    <div class="card_x">
        <div class="card mb-3 border-0">
